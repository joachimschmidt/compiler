class CodeGenerator:
    ...
    from ._utils import check_array_declaration, check_array_reference_by_identifier, check_array_reference_by_number, \
        ...
        restore_registers, load_savepoint, forget_all_registers, backup_registers, forget_register, create_savepoint, \
        check_initialization, variable_to_register, prepare_and_check_initialization
